...
\begin{tikzpicture}[node distance = 3cm, auto]
	...
	\node [decision, left of=loadcontainer] (loadingfinished) {Loading finished?};
	\node [block, left of=loadingfinished](awaiting_physical_clearance_B) {Awaiting physical clearance};
	...
	\path [line] (decision_taskspacefree_A) -- (movetoorigin);
